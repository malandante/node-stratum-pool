...
exports.createGeneration = function(blockHeight, blockReward, feeReward, recipients, poolAddress, masternodeReward, masternodePayee, masternodePayment){
    ...
    if(masternodePayment === 'false') {
            ...
            tx.addOutput(
                scriptCompile(poolAddrHash),
                Math.round(blockReward * (1 - (feePercent / 100))) - masternodeReward
            );
    ...
    */
console.log('masternodePayee: ' + masternodePayee);
console.log('masternodeReward: ' + masternodeReward);
    return txHex;
};
