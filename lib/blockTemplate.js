...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, extraNoncePlaceholder, reward, recipients, poolAddress){
    ...
    masternodeReward = rpcData.masternode.amount;
    masternodePayee = rpcData.masternode.payee;
    masternodePayment = rpcData.masternode.script;
    ...
    if (typeof this.genTx === 'undefined') {
        this.genTx = transactions.createGeneration(rpcData.height, blockReward, this.rewardFees, recipients, poolAddress, masternodeReward, masternodePayee, masternodePayment).toString('hex');
